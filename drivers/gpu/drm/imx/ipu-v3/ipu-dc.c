...
static int ipu_pixfmt_to_map(u32 fmt)
{
	...
	case V4L2_PIX_FMT_RGB24:
		return 0;
	case IPUV3_PIX_FMT_RGB666:
		return 1;
	case V4L2_PIX_FMT_YUV444:
		return 2;
	case V4L2_PIX_FMT_RGB565:
		return 3;
	case IPUV3_PIX_FMT_LVDS666:
		return 4;
	case IPUV3_PIX_FMT_GBR24:
		return 13;
	}
